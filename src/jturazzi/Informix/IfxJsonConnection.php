...
use jturazzi\Informix\Query\Grammars\IfxGrammar;
use jturazzi\Informix\Query\Processors\IfxProcessor;
use jturazzi\Informix\Schema\IfxBuilder;
...
class IfxJsonConnection extends Connection implements ConnectionInterface
{
    ...
    {
        return $this->withTablePrefix(new \jturazzi\Informix\Schema\Grammars\IfxGrammar());
    }
